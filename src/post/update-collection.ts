...
async function updateCollection(ownerPrivateKey: string, tokenAddress: string, network: string, name?: string, metadata_api_url?: string, description?: string, icon_url?: string, collection_image_url?: string): Promise<UpdateCollectionsResults> {
