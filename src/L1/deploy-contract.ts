...
async function main(ownerPrivateKey: string, contract:string, name:string, symbol:string, network:string, gasLimit:string): Promise<void> {
    const deployedContract = await deployContract(ownerPrivateKey, contract, name, symbol, network, gasLimit);
